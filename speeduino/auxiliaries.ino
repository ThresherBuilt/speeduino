...
void vvtControl()
{
  if( (configPage6.vvtEnabled == 1) && (currentStatus.coolant >= (int)(configPage2.aeColdTaperMax - CALIBRATION_TEMPERATURE_OFFSET)) && (BIT_CHECK(currentStatus.engine, BIT_ENGINE_RUN)) )
  {
    //currentStatus.vvt1Duty = 0;
